                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                getData('/authors/page/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset<1){
                                            $this.data('refreshoffset', ++oldOffset);
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            Login().postData('/changeBookStatus' + $this.data('bookid'), {
                        ...
                        } else if ($this.data('sendstatus') === 'KEPT') {
                            Login().postData('/books/changeBookStatus/postponed/' +$this.data('bookid') , {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                        ...
                        else if ($this.data('sendstatus') === 'CART'){
                            Login().postData('/books/changeBookStatus/cart/' +$this.data('bookid') , {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/recent/page')
                                                break;
                                            case'popular':
                                                sendData('/books/popular/page')
                                                break;
                                        }
                                    }
                                }
